...
#define T2_DX(resolution) (70.0 - 10.0) / resolution
#define T2_DY(resolution) (20.0 - (-20.0)) / resolution
#define T2_X_LO(i, dx) (10.0 + i*dx) 
#define T2_X_HI(i, dx) (10.0 + i*dx + dx) 
#define T2_Y_LO(i, dy) (-20.0 + i*dy) 
#define T2_Y_HI(i, dy) (-20.0 + i*dy + dy) 
